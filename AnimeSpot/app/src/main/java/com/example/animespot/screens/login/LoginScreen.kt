...
@Composable
fun LoginScreen(navigateToRegister: () -> Unit, navigateToHome: () -> Unit, authViewModel: AuthViewModel = viewModel()) {
                    ...
                    authViewModel.signInWithEmailAndPassword(email, password)
                        .addOnCompleteListener { task ->
                            if (task.isSuccessful) {
                                ...
                                errorMessage = task.exception?.message ?: "Une erreur s'est produite lors de l'enregistrement."
                            }
                        }
                },
                modifier = Modifier
